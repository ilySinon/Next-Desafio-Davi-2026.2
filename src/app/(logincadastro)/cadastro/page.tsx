...
export default function CadastroInfo() {
  return (
    <main className="min-h-screen w-full flex items-center justify-center p-6 relative">
      ...
      <div className="relative z-20 w-full max-w-md bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 lg:p-10 flex flex-col items-center shadow-2xl overflow-y-auto max-h-[90vh] custom-scrollbar">
        <Link
          href="/"
        ...
        <p className="font-inter text-xs lg:text-sm text-white/90 text-center mb-6">
          Acesse sua conta para acompanhar pedidos.
        </p>

        <div className="w-full flex rounded-xl border border-white/30 p-1 mb-6">
          <Link
            href="/login"
          ...
          <button className="flex-1 bg-[#7a1226] text-white font-inter font-bold text-sm py-3 rounded-lg text-center transition-colors shadow-md cursor-default">
            Cadastro
          </button>
        </div>
        ...
        <form className="w-full flex flex-col gap-4">
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="w-full bg-white/30 border border-white/20 rounded-full px-6 py-3 text-white placeholder:text-white/80 outline-none focus:bg-white/40 focus:border-white/50 transition-all text-sm shadow-inner"
            />
          </div>
