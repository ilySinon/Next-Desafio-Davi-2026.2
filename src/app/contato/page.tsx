  ...
  return (
    <>
      ...
      <main className="w-full min-h-screen bg-[#F6F5EF] flex flex-col items-center">
        <div className="w-full flex flex-col items-center bg-gradient-to-r from-[#65001A] via-[#00100C] to-[#004C23] pt-[180px] pb-24 px-12">
          <h1 className="text-6xl text-center font-anton text-white leading-tight">
            VAMOS CONVERSAR<br/>
            SOBRE O SEU MANTO?
          </h1>
          <p className="font-inter text-gray-300 text-center mt-6 text-sm">
            Dúvidas sobre pedidos, tamanhos ou personalização - estamos prontos para atender a<br/> <br/>
            Nação <span className="font-bold text-white">Tricolor</span>.
          </p>
        </div>
        <div className="w-full max-w-7xl px-12 py-20 flex flex-col gap-16">
          <div className="grid grid-cols-2 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col gap-8">
              <div className="flex items-center gap-4">
                ...
                <h2 className="font-anton text-3xl text-black">ENVIE SUA MENSAGEM</h2>
              </div> 
              {isSubmitFeito && <span className="text-green-500"> Email enviado!</span>}
              {error && <span className="text-red-500"> Email enviado!</span>}
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col gap-8">
              <div className="flex items-center gap-4">
                ...
                <h2 className="font-anton text-3xl text-black">NOSSAS REDES</h2>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col gap-8">
            <div className="flex items-center gap-4">
              ...
              <h2 className="font-anton text-3xl text-black">NOSSA LOJA</h2>
            </div>
            <div className="grid grid-cols-2 gap-8">
              <div className="w-full h-full min-h-[250px] bg-gray-200 rounded-lg flex items-center justify-center text-gray-400">
                <iframe 
