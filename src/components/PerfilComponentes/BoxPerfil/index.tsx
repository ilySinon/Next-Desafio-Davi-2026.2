...
export default function BoxPerfil({ usuario, onOpenModal, onLogout }: BoxPerfilProps) {
  ...
  return (
    <div className="w-full bg-white/40 backdrop-blur-md border border-black/10 rounded-2xl p-8 md:p-12 shadow-xl flex flex-col md:flex-row gap-10 items-center md:items-start justify-between">
      <ImagemPerfil fotoInicial={userData?.imagemperfil} />
