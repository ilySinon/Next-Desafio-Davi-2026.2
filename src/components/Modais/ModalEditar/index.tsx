...
import { editarProduto } from "../../../../actions/modais/modalEditar/actions";
...
export default function ModalEditar({ isOpen, onClose, produto, categorias }: ModalEditarProps) {
      ...
      <div className="w-full max-w-md lg:max-w-2xl max-h-[90vh] overflow-y-auto bg-[#F6F5EF] rounded-2xl p-6 relative shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="w-full">
          ...
          <div className="flex gap-3 lg:gap-4 mb-6">
            {[0, 1, 2].map((index) => {
              const imagemOriginal = produto.variacoes?.[0]?.imagens?.[index]?.nomeImagem;
              const preview = imagens[index] || imagemOriginal;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-8">
            <div className="flex flex-col gap-1 lg:col-span-2">
              ...
              <input
                type="text"
                name="nomeProduto"
                defaultValue={produto.nomeProduto}
                required
            ...
            <div className="flex flex-col gap-1 lg:col-span-2">
              ...
              <textarea
                ...
                defaultValue={produto.produtoDescricao}
                rows={3}
                required
            ...
            <div className="flex flex-col gap-1">
              ...
              <select 
                ...
                defaultValue={produto.idCategoriaProduto}
                required 
                className="w-full bg-transparent border border-gray-300 rounded-lg px-3 py-2 text-sm text-black font-inter outline-none focus:border-gray-500 transition-colors"
              >
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                step="0.01"
                name="preco"
                defaultValue={produto.variacoes?.[0]?.preco}
                required
                className="w-full bg-transparent border border-gray-300 rounded-lg px-3 py-2 text-sm text-black font-inter outline-none focus:border-gray-500 transition-colors"
              />
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                type="text"
                name="nomeCor"
                defaultValue={produto.variacoes?.[0]?.nomeCor}
                required
                className="w-full bg-transparent border border-gray-300 rounded-lg px-3 py-2 text-sm text-black font-inter outline-none focus:border-gray-500 transition-colors"
              />
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <select 
                name="nomeGenero" 
                defaultValue={produto.variacoes?.[0]?.nomeGenero}
                required 
                className="w-full bg-transparent border border-gray-300 rounded-lg px-3 py-2 text-sm text-black font-inter outline-none focus:border-gray-500 transition-colors"
              >
            ...
            <div className="flex flex-col gap-1">
              ...
              <select 
                name="idTamanho" 
                defaultValue={produto.variacoes?.[0]?.estoques?.[0]?.idTamanho}
                required 
                className="w-full bg-transparent border border-gray-300 rounded-lg px-3 py-2 text-sm text-black font-inter outline-none focus:border-gray-500 transition-colors"
              >
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                type="number"
                name="quantidade"
                defaultValue={produto.variacoes?.[0]?.estoques?.[0]?.quantidade}
                required
                className="w-full bg-transparent border border-gray-300 rounded-lg px-3 py-2 text-sm text-black font-inter outline-none focus:border-gray-500 transition-colors"
              />
            </div>
          ...
          {mensagemErro && (
            <div className="mb-4 p-3 rounded-lg bg-red-50 border border-red-200 text-red-600 text-sm font-medium font-inter">
              {mensagemErro}
            </div>
          )}
